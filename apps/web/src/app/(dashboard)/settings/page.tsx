...
const SETTINGS_LINKS: SettingsLink[] = [
  {
    ...
    description: 'Manage dealership name, address, timezone, and branding.',
    icon: (
  ...
  },
  {
    href: '/settings/users',
    title: 'Users & Roles',
    description: 'Manage team members, roles, and user invitations.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Configure lots, boundaries, zones, and spot layouts.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    href: '/settings/notifications',
    title: 'Alert Rules',
    description: 'Create and manage automated alert rules and thresholds.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    title: 'API Keys',
    description: 'Manage API keys for external integrations and programmatic access.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Connect your Dealer Management System for automatic inventory sync.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
